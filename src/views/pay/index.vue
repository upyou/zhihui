<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="setAddressList.address_id">
        <div class="info-content">
          <span class="name">{{setAddressList.name}}</span>
          <span class="mobile">{{setAddressList.phone}}</span>
        </div>
...
<div class="pay-list" v-if="order.goodsList">
  ...
  <div class="pay-detail">
    ...
    <div class="pay-cell">
      <span>配送费用：</span>
      <span v-if="!setAddressList">请先选择配送地址</span>
...
<script>
import { getAddressList, getPay, Order } from '@/api/pay'
...
export default {
  ...
  computed: {
    ...
    longRegion () {
      return this.setAddressList.region.province + this.setAddressList.region.city + this.setAddressList.region.region + this.setAddressList.detail
    },
    mode () {
  ...
  methods: {
    ...
    async getPay () {
      if (this.mode === 'cart') {
        const { data: order } = await getPay(this.mode, {
          cartIds: this.cartIds
        })
